...
namespace nopenotdark\blockalter\task;
...
class BlockReplaceTask extends ClosureTask {
    public function __construct(protected World $world, protected Vector3 $position, protected Block $block) {
    ...
    public function revert(): void {
        $this->world->setBlock($this->position, $this->block);
    }
}